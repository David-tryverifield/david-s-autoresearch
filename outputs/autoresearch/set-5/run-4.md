...
Note: Rep 3 uses split infinitive "to clearly understand" — sounds formal and slightly awkward.
...
Diagnosis: Split infinitive in Rep 3 dropped Q3 by 2 points — the adverb should precede the full verb phrase.

---

## Step 4 — Diagnose

Q3 weakest. Stub skill needs an explicit rule against split infinitives.
...
Updated: "Rewrite the sentence to be more concise. Do not use split infinitives — place the adverb before the full verb, not between 'to' and the verb."
